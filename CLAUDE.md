...
- IMPORTANT: ALWAYS commit the results of `pnpm build` before finalizing a task.
...
- All CSS classes should have the prefix `{{PLUGIN_PREFIX}}-`.
- All user data attributes should start with `data-{{PLUGIN_PREFIX}}-`
